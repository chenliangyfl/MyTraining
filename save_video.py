...
class ProgressData(object):
    ...
    def output(self):
        ...
        if loaded >= self.size:
            ...
            print u"{0}下载进度{1:.2f}{2}/{3:.2f}{4} {5:.2%} 下载速度{6:.2f}{7}'s".format(self.file_name, loaded, self.unit, self.size, self.unit, progress, speed, self.unit)
